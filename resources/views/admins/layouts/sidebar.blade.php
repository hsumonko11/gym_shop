      ...
      <div class="logo-header" data-background-color="dark">
        <a href="{{route('admin.dashboard')}}" class="logo">
          {{-- <img
            ...
            height="20"
          /> --}}
          <h5 class="text-white">Gym Accessories Shop</h5>
        </a>
        ...
        <ul class="nav nav-secondary">
          <li class="nav-item @yield('dashboard-active')">
            ...
            <i class="fas fa-home"></i>
              <p style="font-size: 18px">ပင်မစာမျက်နှာ</p>
          ...
          <li class="nav-item @yield('customer-active')">
            <a href="{{route('admin.customers.index')}}">
              ...
              <p style="font-size: 18px">ဈေးဝယ်သူများ</p>
          ...
          <li class="nav-item @yield('product-active')">
            <a href="{{route('admin.products.index')}}">
              ...
              <p style="font-size: 18px">ကုန်ပစ္စည်းများ </p>
          ...
          <li class="nav-item @yield('category-active')">
            <a href="{{route('admin.categories.index')}}">
              ...
              <p style="font-size: 18px">အမျိုးအစားများ </p>
          ...
          <li class="nav-item @yield('supplier-active')">
            <a href="{{route('admin.suppliers.index')}}">
              ...
              <p style="font-size: 18px">တင်သွင်းသူများ </p>
          ...
          <li class="nav-item @yield('supplier-product-active')">
            <a href="{{route('admin.supplier_products.index')}}">
              ...
              <p style="font-size: 18px">တင်သွင်းသောကုန်ပစ္စည်းများ</p>
          ...
          <li class="nav-item @yield('order-active')">
            <a href="{{route('admin.orders.index')}}">
              ...
              <p style="font-size: 18px">မှာယူမှုများ</p>
          ...
          <li class="nav-item @yield('contact-active')">
            <a href="{{route('admin.contact')}}">
                <i class="fas fa-eye"></i>
              <p style="font-size: 18px">အကြံပြုစာများ</p>
