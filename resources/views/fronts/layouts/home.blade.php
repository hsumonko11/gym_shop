...
@section('home-active','active-menu')
...
@section('content')
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			...
			<div class="slick1">
				<div class="item-slick1" style="background-image: url({{asset('fronts/photos/girl.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									ခေတ်မီဆန်းသစ်ပြီး အမျိုးပေါင်းများစွာရှိတဲ့ fitness equipment တွေကို
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url({{asset('fronts/photos/banana.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									အိမ်သုံး Gymသုံး quality မျိုးစုံကို
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url({{asset('fronts/photos/slide03.jpg')}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Qualityပိုင်းနဲ့ပက်သက်လို့ အာမခံမှု အပြည့်အဝရှိတဲ့
								</span>
							</div>
		...
		<div class="container">
			<div class="row">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{asset('fronts/photos/banana.jpg')}}" alt="IMG-BANNER" style="width:370px;height:240px;">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{asset('fronts/photos/weight.jpeg')}}" alt="IMG-BANNER" style="width:370px;height:240px;">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					<div class="block2">
                        ...
                        <div class="d-flex justify-content-between p-3 home-product">
                            ...
                            <div>
                                <span class="text-info">{{$product->price}}</span> MMK
                            </div>
                        </div>
